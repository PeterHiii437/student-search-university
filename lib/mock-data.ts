...
export const MOCK_STUDENTS: Student[] = [
  {
    id: 1,
    mssv: "24180001", // MaSV
    ho_ten: "HUỲNH MINH KHÔI", // HoTen
    gioi_tinh: "Nam", // Phai
    ngay_sinh: "2006-07-02", // NgaySinh
    cccd: "08020600****", // CMND (masked)
    email: "huynhminhkhoia1.c3hn2021@gmail.com", // Email
    dien_thoai: "039597****", // DienThoai (masked)
    so_bao_danh: "49010875", // SBD
    ma_hs: "PYZIAX", // MaHS
    ho_khau: "Huyện Đức Hòa, Long An", // HoKhau
    ma_nganh: "7420201", // MaNganh
    ten_nganh: "Công nghệ Sinh học", // TenNganh
    truong_thpt: "THPT chuyên tỉnh Long An", // Truong_THPT
    doat_giai:
      "Giải Nhì - Kỳ thi khoa học kỹ thuật cấp quốc gia - Lĩnh vực Hóa học - Năm 2024", // DoatGiai
    phuong_thuc: "XTT_BoGD", // DTT
    diem_tt: 0, // Diem_TT
    ...
    phuong_thuc_nhap_hoc:
      "Xét tuyển thẳng theo quy định của Bộ Giáo dục & Đào tạo 2024",
  ...
  },
  {
    id: 2,
    mssv: "24180002", // MaSV
    ho_ten: "LÊ HOÀNG TRUNG", // HoTen
    gioi_tinh: "Nam", // Phai
    ngay_sinh: "2006-09-29", // NgaySinh
    cccd: "09120600****", // CMND (masked)
    email: "trungkg2992006@gmail.com", // Email
    dien_thoai: "094806****", // DienThoai (masked)
    so_bao_danh: "54003432", // SBD
    ma_hs: "CYTPET", // MaHS
    ho_khau: "Thành phố Rạch Giá, Kiên Giang", // HoKhau
    ma_nganh: "7420201", // MaNganh
    ten_nganh: "Công nghệ Sinh học", // TenNganh
    truong_thpt: "THPT chuyên Huỳnh Mẫn Đạt, Kiên Giang", // Truong_THPT
    doat_giai:
      "Giải Ba - Kỳ thi chọn học sinh giỏi cấp quốc gia- Môn Sinh học - Năm 2024", // DoatGiai
    phuong_thuc: "XTT_BoGD", // DTT
    diem_tt: 0, // Diem_TT
  ...
  },
  {
    id: 3,
    mssv: "24150113", // MaSV
    ho_ten: "NGUYỄN TRƯƠNG THÁI HẰNG", // HoTen
    gioi_tinh: "Nữ", // Phai
    ngay_sinh: "2006-07-22", // NgaySinh
    cccd: "08230600****", // CMND (masked)
    email: "ntth220706@gmail.com", // Email
    dien_thoai: "036276****", // DienThoai (masked)
    so_bao_danh: "53007937", // SBD
    ma_hs: "YTTC7G", // MaHS
    ho_khau: "Phường 5, Thành phố Mỹ Tho, Tiền Giang", // HoKhau
    ma_nganh: "7420101", // MaNganh
    ten_nganh: "Sinh học", // TenNganh
    truong_thpt: "THPT Nguyễn Đình Chiểu, Tiền Giang", // Truong_THPT
    doat_giai: "", // DoatGiai
    phuong_thuc: "UTX_DHQG", // DTT
    diem_tt: 8.92, // Diem_TT
    ...
    phuong_thuc_nhap_hoc:
      "ƯTXT Học sinh Giỏi các trường THPT theo quy định của ĐHQG-HCM 2024",
    ho_so_can_thiet: ADMISSION_METHODS[0].documents,
    trang_thai_duyet: "pending",
    khoa: "Khoa Sinh học",
    nganh: "Sinh học",
  ...
  },
  {
    id: 4,
    mssv: "24110116", // MaSV
    ho_ten: "LÝ GIA KHANG", // HoTen
    gioi_tinh: "Nam", // Phai
    ngay_sinh: "2006-03-25", // NgaySinh
    cccd: "07920603****", // CMND (masked)
    email: "khang25032006@gmail.com", // Email
    dien_thoai: "037601****", // DienThoai (masked)
    so_bao_danh: "02054042", // SBD
    ma_hs: "TGPUVK", // MaHS
    ho_khau: "Phường Hiệp Tân, Quận Tân Phú, TP.HCM", // HoKhau
    ma_nganh: "7460101_NN", // MaNganh
    ten_nganh: "Nhóm ngành Toán học, Toán ứng dụng, Toán tin", // TenNganh
    truong_thpt: "THPT Tạ Quang Bửu, Tp. Hồ Chí Minh", // Truong_THPT
    doat_giai: "", // DoatGiai
    phuong_thuc: "XTT_DHQG", // DTT
    diem_tt: 9.47, // Diem_TT
    ...
    phuong_thuc_nhap_hoc:
      "ƯTXTT Học sinh Giỏi nhất Trường THPT theo quy định của ĐHQG-HCM 2024",
    ho_so_can_thiet: ADMISSION_METHODS[0].documents,
    trang_thai_duyet: "approved",
    nguoi_duyet: "admin@hcmus.edu.vn",
  ...
  },
  {
    id: 5,
    mssv: "24150125", // MaSV
    ho_ten: "HÀ NGUYỄN CHU THỊ VÂN ANH", // HoTen
    gioi_tinh: "Nữ", // Phai
    ngay_sinh: "2006-09-17", // NgaySinh
    cccd: "07030600****", // CMND (masked)
    email: "anhhnctv.d.2124@gmail.com", // Email
    dien_thoai: "083643****", // DienThoai (masked)
    so_bao_danh: "44000067", // SBD
    ma_hs: "", // MaHS (empty)
    ho_khau: "Huyện Bàu Bàng, Bình Dương", // HoKhau
    ma_nganh: "7420101", // MaNganh
    ten_nganh: "Sinh học", // TenNganh
    truong_thpt: "THPT chuyên Hùng Vương, Bình Dương", // Truong_THPT
    doat_giai: "", // DoatGiai
    phuong_thuc: "THPT", // DTT
    diem_tt: 24.15, // Diem_TT
